...
1. Find the sync-storage version for your adapter release: check out the release tag and look for the `syncStorageVersion` value. You can use our [script](https://github.com/testit-tms/adapters-go/blob/main/scripts/get_sync_storage_version.sh).
