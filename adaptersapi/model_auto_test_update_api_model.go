...
func (o *AutoTestUpdateApiModel) GetTags() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AutoTestUpdateApiModel) GetTagsOk() ([]string, bool) {
...
func (o *AutoTestUpdateApiModel) HasTags() bool {
	if o != nil && !IsNil(o.Tags) {
		return true
	}
...
func (o *AutoTestUpdateApiModel) SetTags(v []string) {
	o.Tags = v
}
