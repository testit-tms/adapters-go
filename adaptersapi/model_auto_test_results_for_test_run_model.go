...
type _AutoTestResultsForTestRunModel AutoTestResultsForTestRunModel
...
func (o *AutoTestResultsForTestRunModel) UnmarshalJSON(data []byte) (err error) {
	...
	varAutoTestResultsForTestRunModel := _AutoTestResultsForTestRunModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAutoTestResultsForTestRunModel)

	if err != nil {
		return err
	}

	*o = AutoTestResultsForTestRunModel(varAutoTestResultsForTestRunModel)
