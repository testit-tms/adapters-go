...
// checks if the LinkApiResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkApiResult{}

// LinkApiResult struct for LinkApiResult
type LinkApiResult struct {
...
func (o *LinkApiResult) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *LinkApiResult) SetDescriptionNil() {
...
func (o LinkApiResult) MarshalJSON() ([]byte, error) {
...
func (o LinkApiResult) ToMap() (map[string]interface{}, error) {
...
func (o *LinkApiResult) UnmarshalJSON(data []byte) (err error) {
	...
	varLinkApiResult := _LinkApiResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLinkApiResult)

	if err != nil {
		return err
	}

	*o = LinkApiResult(varLinkApiResult)

	return err
}

type NullableLinkApiResult struct {
	value *LinkApiResult
	isSet bool
}

func (v NullableLinkApiResult) Get() *LinkApiResult {
	return v.value
}

func (v *NullableLinkApiResult) Set(val *LinkApiResult) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkApiResult) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkApiResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkApiResult(val *LinkApiResult) *NullableLinkApiResult {
	return &NullableLinkApiResult{value: val, isSet: true}
}

func (v NullableLinkApiResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkApiResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
