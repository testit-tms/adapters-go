...
// checks if the AutoTestStepResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutoTestStepResult{}

// AutoTestStepResult struct for AutoTestStepResult
type AutoTestStepResult struct {
...
func (o *AutoTestStepResult) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *AutoTestStepResult) SetDescriptionNil() {
...
func (o *AutoTestStepResult) SetInfoNil() {
	o.Info.Set(nil)
}
...
func (o *AutoTestStepResult) SetStartedOnNil() {
	o.StartedOn.Set(nil)
}
...
func (o *AutoTestStepResult) SetCompletedOnNil() {
...
func (o *AutoTestStepResult) GetDuration() int64 {
...
func (o *AutoTestStepResult) SetDurationNil() {
	o.Duration.Set(nil)
}
...
func (o *AutoTestStepResult) SetOutcomeNil() {
	o.Outcome.Set(nil)
}
...
// SetStepResults gets a reference to the given []AutoTestStepResult and assigns it to the StepResults field.
...
func (o AutoTestStepResult) MarshalJSON() ([]byte, error) {
...
func (o AutoTestStepResult) ToMap() (map[string]interface{}, error) {
...
type NullableAutoTestStepResult struct {
	value *AutoTestStepResult
	isSet bool
}

func (v NullableAutoTestStepResult) Get() *AutoTestStepResult {
	return v.value
}

func (v *NullableAutoTestStepResult) Set(val *AutoTestStepResult) {
	v.value = val
	v.isSet = true
}

func (v NullableAutoTestStepResult) IsSet() bool {
	return v.isSet
}

func (v *NullableAutoTestStepResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutoTestStepResult(val *AutoTestStepResult) *NullableAutoTestStepResult {
	return &NullableAutoTestStepResult{value: val, isSet: true}
}

func (v NullableAutoTestStepResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutoTestStepResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
