...
type _LinkPostModel LinkPostModel
...
func (o *LinkPostModel) UnmarshalJSON(data []byte) (err error) {
	...
	varLinkPostModel := _LinkPostModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLinkPostModel)

	if err != nil {
		return err
	}

	*o = LinkPostModel(varLinkPostModel)
