...
type _ConfigurationModel ConfigurationModel
...
func (o *ConfigurationModel) UnmarshalJSON(data []byte) (err error) {
	...
	varConfigurationModel := _ConfigurationModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConfigurationModel)

	if err != nil {
		return err
	}

	*o = ConfigurationModel(varConfigurationModel)
