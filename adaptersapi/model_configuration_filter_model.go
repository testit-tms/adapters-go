...
// checks if the ConfigurationFilterModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigurationFilterModel{}

// ConfigurationFilterModel struct for ConfigurationFilterModel
type ConfigurationFilterModel struct {
...
func (o *ConfigurationFilterModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ConfigurationFilterModel) SetIsDeletedNil() {
	o.IsDeleted.Set(nil)
}
...
func (o ConfigurationFilterModel) MarshalJSON() ([]byte, error) {
...
func (o ConfigurationFilterModel) ToMap() (map[string]interface{}, error) {
...
type NullableConfigurationFilterModel struct {
	value *ConfigurationFilterModel
	isSet bool
}

func (v NullableConfigurationFilterModel) Get() *ConfigurationFilterModel {
	return v.value
}

func (v *NullableConfigurationFilterModel) Set(val *ConfigurationFilterModel) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigurationFilterModel) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigurationFilterModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigurationFilterModel(val *ConfigurationFilterModel) *NullableConfigurationFilterModel {
	return &NullableConfigurationFilterModel{value: val, isSet: true}
}

func (v NullableConfigurationFilterModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigurationFilterModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
