...
// checks if the TestResultLinkApiResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TestResultLinkApiResult{}

// TestResultLinkApiResult struct for TestResultLinkApiResult
type TestResultLinkApiResult struct {
...
type _TestResultLinkApiResult TestResultLinkApiResult

// NewTestResultLinkApiResult instantiates a new TestResultLinkApiResult object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTestResultLinkApiResult(url string, type_ LinkType) *TestResultLinkApiResult {
	this := TestResultLinkApiResult{}
	this.Url = url
	this.Type = type_
	return &this
}
...
func (o *TestResultLinkApiResult) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *TestResultLinkApiResult) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *TestResultLinkApiResult) SetDescriptionNil() {
...
func (o *TestResultLinkApiResult) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o TestResultLinkApiResult) MarshalJSON() ([]byte, error) {
...
func (o TestResultLinkApiResult) ToMap() (map[string]interface{}, error) {
...
func (o *TestResultLinkApiResult) UnmarshalJSON(data []byte) (err error) {
	...
	varTestResultLinkApiResult := _TestResultLinkApiResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestResultLinkApiResult)

	if err != nil {
		return err
	}

	*o = TestResultLinkApiResult(varTestResultLinkApiResult)

	return err
}

type NullableTestResultLinkApiResult struct {
	value *TestResultLinkApiResult
	isSet bool
}

func (v NullableTestResultLinkApiResult) Get() *TestResultLinkApiResult {
	return v.value
}

func (v *NullableTestResultLinkApiResult) Set(val *TestResultLinkApiResult) {
	v.value = val
	v.isSet = true
}

func (v NullableTestResultLinkApiResult) IsSet() bool {
	return v.isSet
}

func (v *NullableTestResultLinkApiResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestResultLinkApiResult(val *TestResultLinkApiResult) *NullableTestResultLinkApiResult {
	return &NullableTestResultLinkApiResult{value: val, isSet: true}
}

func (v NullableTestResultLinkApiResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestResultLinkApiResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
